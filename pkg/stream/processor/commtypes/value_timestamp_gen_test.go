...
func TestMarshalUnmarshalValueTimestamp(t *testing.T) {
	v := ValueTimestamp{}
...
func BenchmarkMarshalMsgValueTimestamp(b *testing.B) {
	v := ValueTimestamp{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgValueTimestamp(b *testing.B) {
	v := ValueTimestamp{}
...
func BenchmarkUnmarshalValueTimestamp(b *testing.B) {
	v := ValueTimestamp{}
...
func TestEncodeDecodeValueTimestamp(t *testing.T) {
	v := ValueTimestamp{}
	...
	m := v.Msgsize()
	if buf.Len() > m {
		t.Log("WARNING: TestEncodeDecodeValueTimestamp Msgsize() is inaccurate")
	}
...
func BenchmarkEncodeValueTimestamp(b *testing.B) {
	v := ValueTimestamp{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
...
func BenchmarkDecodeValueTimestamp(b *testing.B) {
	v := ValueTimestamp{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
