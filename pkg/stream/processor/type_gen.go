...
// fields of ValueTimestampSerialized
var decodeMsgFieldOrder0zgensym_86cf238d4b0a69cf_1 = []string{"Timestamp_zid00_u64", "ValueSerialized_zid01_bin"}

var decodeMsgFieldSkip0zgensym_86cf238d4b0a69cf_1 = []bool{false, false}

// fieldsNotEmpty supports omitempty tags
func (z *ValueTimestampSerialized) fieldsNotEmpty(isempty []bool) uint32 {
	if len(isempty) == 0 {
		return 2
	}
	var fieldsInUse uint32 = 2
	isempty[0] = (z.Timestamp == 0) // number, omitempty
	if isempty[0] {
		fieldsInUse--
	}
	isempty[1] = (len(z.ValueSerialized) == 0) // string, omitempty
	if isempty[1] {
		fieldsInUse--
	}
...
func (z *ValueTimestampSerialized) EncodeMsg(en *msgp.Writer) (err error) {
	...
	// runtime struct type identification for 'ValueTimestampSerialized'
	err = en.Append(0xa1, 0x40)
	if err != nil {
		return err
	}
	err = en.WriteStringFromBytes([]byte{0x56, 0x61, 0x6c, 0x75, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x53, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x64})
	if err != nil {
		return err
	}

	if !empty_zgensym_86cf238d4b0a69cf_2[0] {
		// write "Timestamp_zid00_u64"
		err = en.Append(0xb3, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x5f, 0x7a, 0x69, 0x64, 0x30, 0x30, 0x5f, 0x75, 0x36, 0x34)
		if err != nil {
			return err
		}
	...
	if !empty_zgensym_86cf238d4b0a69cf_2[1] {
		// write "ValueSerialized_zid01_bin"
		err = en.Append(0xb9, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x53, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x64, 0x5f, 0x7a, 0x69, 0x64, 0x30, 0x31, 0x5f, 0x62, 0x69, 0x6e)
		if err != nil {
			return err
		}
...
func (z *ValueTimestampSerialized) MarshalMsg(b []byte) (o []byte, err error) {
	...
	if !empty[0] {
		// string "Timestamp_zid00_u64"
		o = append(o, 0xb3, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x5f, 0x7a, 0x69, 0x64, 0x30, 0x30, 0x5f, 0x75, 0x36, 0x34)
		o = msgp.AppendUint64(o, z.Timestamp)
	}

	if !empty[1] {
		// string "ValueSerialized_zid01_bin"
		o = append(o, 0xb9, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x53, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x64, 0x5f, 0x7a, 0x69, 0x64, 0x30, 0x31, 0x5f, 0x62, 0x69, 0x6e)
...
func (z *ValueTimestampSerialized) UnmarshalMsgWithCfg(bts []byte, cfg *msgp.RuntimeConfig) (o []byte, err error) {
	...
	for encodedFieldsLeft4zgensym_86cf238d4b0a69cf_5 > 0 || missingFieldsLeft4zgensym_86cf238d4b0a69cf_5 > 0 {
		...
		case "ValueSerialized_zid01_bin":
			...
			if nbs.AlwaysNil || msgp.IsNil(bts) {
				...
				z.ValueSerialized = z.ValueSerialized[:0]
			} else {
				z.ValueSerialized, bts, err = nbs.ReadBytesBytes(bts, z.ValueSerialized)
...
// fields of ValueTimestampSerialized
var unmarshalMsgFieldOrder4zgensym_86cf238d4b0a69cf_5 = []string{"Timestamp_zid00_u64", "ValueSerialized_zid01_bin"}
...
func (z *ValueTimestampSerialized) Msgsize() (s int) {
	s = 1 + 20 + msgp.Uint64Size + 26 + msgp.BytesPrefixSize + len(z.ValueSerialized)
	return
}
