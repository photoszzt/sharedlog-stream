...
func (z *TxnMarker) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	for zb0001 > 0 {
		...
		case "tid":
			z.TranIDOrScaleEpoch, err = dc.ReadUint64()
			if err != nil {
				err = msgp.WrapError(err, "TranIDOrScaleEpoch")
				return
			}
		case "mk":
...
func (z TxnMarker) EncodeMsg(en *msgp.Writer) (err error) {
	...
	if (zb0001Mask & 0x1) == 0 { // if not empty
		...
		err = en.WriteUint64(z.TranIDOrScaleEpoch)
		if err != nil {
			err = msgp.WrapError(err, "TranIDOrScaleEpoch")
			return
		}
...
func (z TxnMarker) MarshalMsg(b []byte) (o []byte, err error) {
	...
	if (zb0001Mask & 0x1) == 0 { // if not empty
		...
		o = msgp.AppendUint64(o, z.TranIDOrScaleEpoch)
	}
	// string "mk"
...
func (z *TxnMarker) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		switch msgp.UnsafeString(field) {
		case "tid":
			z.TranIDOrScaleEpoch, bts, err = msgp.ReadUint64Bytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "TranIDOrScaleEpoch")
				return
			}
