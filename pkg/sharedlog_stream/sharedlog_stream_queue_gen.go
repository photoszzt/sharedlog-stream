...
func (z *StreamQueueAuxData) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
...
func (z StreamQueueAuxData) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 2
	// write "consumed"
...
func (z StreamQueueAuxData) MarshalMsg(b []byte) (o []byte, err error) {
...
func (z *StreamQueueAuxData) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
...
func (z StreamQueueAuxData) Msgsize() (s int) {
	s = 1 + 9 + msgp.Uint64Size + 5 + msgp.Uint64Size
	return
}

// DecodeMsg implements msgp.Decodable
func (z *StreamQueueLogEntry) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
...
// EncodeMsg implements msgp.Encodable
func (z *StreamQueueLogEntry) EncodeMsg(en *msgp.Writer) (err error) {
...
// MarshalMsg implements msgp.Marshaler
func (z *StreamQueueLogEntry) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// omitempty: check for empty values
	zb0001Len := uint32(3)
	var zb0001Mask uint8 /* 3 bits */
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *StreamQueueLogEntry) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
