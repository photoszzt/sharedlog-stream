...
APP_NAME=$1
GUA=${2:-alo}
./bin/nexmark_client -app_name $APP_NAME -wconfig ./workload_config/1node/1_ins/${APP_NAME}.json \
    ...
    -fail_spec ./workload_config/1node/1_ins/failure_config/${APP_NAME}.json -snapshot_everyS=10
